            ...
            >
              ...
              {activeTab === tab.id && (
                <div className={`ml-2 w-2 h-2 rounded-full animate-pulse ${
                  isDarkMode ? "bg-cyan-300" : "bg-blue-400"
                }`}></div>
              )}
            </motion.button>
          ))}
            ...
            <div className={`p-8 rounded-2xl backdrop-blur-sm border ${
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative">
                  ...
                  />
                  <div className={`absolute -inset-4 border-2 rounded-full animate-spin-slow ${
                    isDarkMode ? 'border-cyan-500/30' : 'border-blue-400/30'
                  }`}></div>
                </div>
                <div className="flex-1">
                  ...
                  <div className={`p-6 rounded-xl ${
                    isDarkMode ? 'bg-gray-900/50 border-gray-700' : 'bg-white/50 border-blue-100'
                  } border`}>
...
<div className={`p-8 rounded-2xl backdrop-blur-sm border ${
  ...
  <div className={`p-6 rounded-xl mb-6 ${
    isDarkMode ? 'bg-gray-900/30 border-gray-700' : 'bg-white/30 border-blue-100'
  } border`}>
   <p className="leading-relaxed">
  My name is{" "}
  <span
...
>
      ...
      <div className="flex items-center gap-3 mb-2">
        <div
          className={`w-2 h-2 rounded-full ${
            isDarkMode ? "bg-green-400 animate-pulse" : "bg-green-500"
          }`}
        ></div>
        <span
          className={`font-semibold ${
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {[
      ...
      <div
        key={index}
        className={`p-4 rounded-xl bg-gradient-to-br ${cert.color} border ${
  ...
  learn, build, and improve with clarity and purpose.
    ...
    <div className="flex items-center gap-3 mt-6">
      <div className={`w-3 h-3 rounded-full ${
        isDarkMode ? 'bg-cyan-400 animate-pulse' : 'bg-cyan-500'
      }`}></div>
            ...
            <div className={`p-8 rounded-2xl backdrop-blur-sm border ${
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative">
                  ...
                  />
                  <div className={`absolute -inset-2 border-2 rounded-full animate-spin-slow ${
                    isDarkMode ? 'border-cyan-500/30' : 'border-blue-400/30'
                  }`}></div>
                </div>
                <div className="flex-1">
...
<p className="leading-relaxed">
  ...
  Tailwind CSS, and production-grade development practices.
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`inline-flex items-center mt-6 px-6 py-3 rounded-lg transition-all shadow-lg ${
                      isDarkMode
                ...
                {skillSystems[activeSystem].map((skill) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-xl border ${
                      isDarkMode ? 'bg-gray-900/50 border-gray-700/50' : 'bg-white/50 border-blue-100'
                    }`}
                  ...
                  <div key={index} className="space-y-4">
                    <div>
                      <h3 className={`text-xl font-semibold bg-gradient-to-r ${
                        isDarkMode ? 'from-blue-400 to-cyan-300' : 'from-blue-600 to-cyan-500'
                      } bg-clip-text text-transparent`}>
                        {edu.institution}
                      </h3>
  ...
  >
    <div className={`p-8 rounded-2xl backdrop-blur-sm border ${
              ...
              <div className={`w-full rounded-full h-2 ${
                ...
                <div 
                  className={`h-2 rounded-full bg-gradient-to-r ${
                    isDarkMode ? 'from-cyan-500 to-blue-500' : 'from-blue-500 to-cyan-400'
                  }`}
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-4 rounded-lg focus:outline-none focus:ring-2 transition ${
                      isDarkMode 
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full p-4 rounded-lg focus:outline-none focus:ring-2 transition resize-none ${
                      isDarkMode 
                        ? 'bg-gray-900/50 border border-gray-700 focus:border-cyan-500 focus:ring-cyan-500/20'
                        : 'bg-white border border-gray-300 focus:border-blue-500 focus:ring-blue-500/20'
                    }`}
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full py-4 rounded-lg font-medium transition-all shadow-lg ${
                    isDarkMode
      ...
      {/* Footer */}
      <footer className={`mt-12 pt-8 border-t relative z-10 ${

...
const GlassCard3D = ({ children, className = "", isDarkMode = true, glowType = "cyan" }) => {
  return (
    <div
      className={`relative rounded-2xl flex flex-col justify-between overflow-hidden ${isDarkMode
          ? "glass-card-style glow-" + glowType
          : "bg-white/80 border border-gray-200/50 hover:shadow-lg shadow-blue-500/10 hover:scale-[1.01] transition-all duration-300 ease-out"
        } ${className}`}
    >
      {/* Cybernetic accent line */}
      <div className={`absolute inset-x-0 top-0 h-[1.5px] bg-gradient-to-r from-transparent ${
        glowType === "purple" ? "via-purple-500/50" : "via-cyan-400/50"
      } to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500 z-10`} />
...
const HeaderLogo = ({ isDarkMode }) => {
  return (
    <div className="flex items-center justify-center relative w-16 h-16 group select-none pointer-events-none">
      ...
      <div className="absolute inset-2 rounded-full border border-cyan-500/20 border-t-cyan-400 border-b-blue-500 animate-spin-reverse" />

      {/* Inner logo frame */}
      <div className="absolute inset-3 rounded-full overflow-hidden bg-white/[0.03] border border-white/20 backdrop-blur-md flex items-center justify-center shadow-[0_0_15px_rgba(0,234,255,0.2)]">
        <img src={logoImg} alt="FuncLexa Logo" className="w-full h-full object-cover rounded-full" />
      </div>
    </div>
  );
};
...
const Portfolio = () => {
  ...
  const skillSystems = {
    ...
    tools: [
      ...
      { name: "Netlify", level: 90, color: "bg-gradient-to-r from-blue-400 to-cyan-500", icon: "🚀" },
      { name: "Render", level: 85, color: "bg-gradient-to-r from-purple-500 to-pink-500", icon: "⚙️" },
    ],
    "gen-ai": [
      { name: "Generative AI", level: 80, color: "bg-gradient-to-r from-purple-500 to-pink-500", icon: "🤖" },
      { name: "OpenAI API", level: 85, color: "bg-gradient-to-r from-green-500 to-emerald-500", icon: "⚡" },
      { name: "Prompt Engineering", level: 82, color: "bg-gradient-to-r from-blue-500 to-cyan-500", icon: "💬" },
      { name: "AI Image Generation", level: 75, color: "bg-gradient-to-r from-indigo-500 to-purple-500", icon: "🎨" },
      { name: "LangChain", level: 70, color: "bg-gradient-to-r from-yellow-500 to-orange-500", icon: "⛓️" },
      { name: "Vector Databases", level: 65, color: "bg-gradient-to-r from-gray-600 to-gray-800", icon: "🗃️" },
    ],
    cybersecurity: [
      { name: "Network Security", level: 75, color: "bg-gradient-to-r from-red-500 to-pink-500", icon: "🛡️" },
      { name: "Cryptography", level: 68, color: "bg-gradient-to-r from-yellow-600 to-amber-500", icon: "🔐" },
      { name: "Security Protocols", level: 72, color: "bg-gradient-to-r from-green-600 to-teal-500", icon: "🔒" },
      { name: "Risk Assessment", level: 65, color: "bg-gradient-to-r from-orange-500 to-red-600", icon: "📊" },
    ],
    "cloud-tools": [
      { name: "Google Cloud Fundamentals", level: 75, color: "bg-gradient-to-r from-orange-500 to-yellow-500", icon: "☁️" },
    ],
  };
  ...
  const ongoingProjects = [
    {
      ...
      description: "An intelligent AI-powered virtual assistant designed for developers, learners, and productivity-focused users.",
    ...
    {
      name: "FuncSpan",
      description: "A deep-dive developer sandbox built to intercept live API payloads, inject HTTP status codes, and simulate custom network latency.",
      longDescription: "FuncSpan is a full-stack developer utility and network simulation engine operating as a core submodule within the FuncSilo ecosystem. It enables real-time HTTP traffic inspection, artificial latency injection, response payload hotwiring, and custom API error state simulation for robust client-side edge-case testing.",
      demoLink: "https://funcspan.funclexa.dev/",
      githubLink: "https://github.com/ansarisultan/",
      tech: ["React", "Node.js", "Proxy Engine", "Traffic Inspector"],
  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${isDarkMode
        ? 'bg-gradient-to-br from-[#020617] via-[#041226] to-[#07182E] text-white'
        : 'bg-gradient-to-br from-slate-50 via-cyan-50/20 to-blue-50/30 text-gray-900'
      } p-6 relative overflow-x-hidden`}>
      <CustomCursor />
      {/* Background Glowing Blobs */}
      <div className="absolute top-10 left-10 w-72 h-72 rounded-full bg-cyan-500/10 blur-[120px] pointer-events-none z-0" />
      <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-purple-500/5 blur-[150px] pointer-events-none z-0" />
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === "about" && (
          ...
          >
            {/* Hero Section */}
            <GlassCard3D isDarkMode={isDarkMode} className="p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative">
                  <img
                    src="/profile1.jpeg"
                    alt="Sultan Salauddin Ansari"
                    className="w-48 h-48 rounded-full object-cover border border-cyan-400/40 shadow-lg"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Passion Card */}
              <GlassCard3D isDarkMode={isDarkMode} className="p-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {aboutSultan.specialties.map((specialty, index) => (
                      <span key={index} className={`px-4 py-2 rounded-full text-sm font-medium ${isDarkMode
                          ? 'bg-blue-950/40 text-cyan-300 border border-blue-700/30'
              ...
              {/* Philosophy Card */}
              <GlassCard3D isDarkMode={isDarkMode} className="p-6" glowType="purple">
                <div className="flex items-center gap-3 mb-4">
            ...
            <GlassCard3D isDarkMode={isDarkMode} className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {aboutSultan.funFacts.map((fact, index) => (
                  <div
                    key={index}
                    className={`p-5 rounded-xl text-center ${isDarkMode
                        ? 'bg-gray-900/50 border-gray-700/50'
                        : 'bg-white/80 border-gray-200'
                      } border shadow-sm transition-transform duration-300 hover:scale-[1.03]`}
                  >
            ...
            <GlassCard3D isDarkMode={isDarkMode} className="p-8">
              ...
              <div className={`p-6 rounded-xl mb-6 ${isDarkMode ? 'bg-gray-900/30 border-gray-700/50' : 'bg-white/30 border-blue-100/50'
                } border`}>
                <p className="leading-relaxed">
                  My name is{" "}
                  <span className={`font-semibold ${isDarkMode ? "text-cyan-300" : "text-blue-600"}`}>
                    Sultan Salauddin Ansari
                  </span>
                  , and my journey with technology began at a very young age. I started exploring
                  computers early on, and by the age of{" "}
                  <span className={`px-2 py-1 rounded-full ${isDarkMode ? "bg-cyan-900/50 text-cyan-300" : "bg-cyan-100 text-cyan-700"
                    }`}>
                    12
                  </span>
              ...
              {/* Funclexa Showcase */}
              <div className={`p-8 rounded-2xl mb-8 ${isDarkMode
                  ? "bg-gradient-to-r from-gray-800/40 to-gray-900/40 border border-gray-700/50"
                  : "bg-gradient-to-r from-white/70 to-gray-50/70 border border-gray-200/50"
                } backdrop-blur-md`}>
                <div className="flex items-center gap-4 mb-6">
                  <div className={`p-3 rounded-lg ${isDarkMode ? "bg-cyan-900/50" : "bg-cyan-100"}`}>
                    <FiCpu className={isDarkMode ? "text-cyan-400" : "text-cyan-600"} size={32} />
                  </div>
                  <div>
                    <h4 className={`text-2xl font-bold ${isDarkMode ? "text-cyan-300" : "text-cyan-700"}`}>
                ...
                <div className="space-y-4">
                  ...
                  <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-800/50" : "bg-gray-50"}`}>
                    <div className="flex items-center gap-3 mb-2">
                      <div className={`w-2 h-2 rounded-full ${isDarkMode ? "bg-green-400 animate-pulse" : "bg-green-500"}`}></div>
                  ...
                  <p className={`italic ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    ...
                    of learning, and my vision for building intelligent, user-first digital systems.”
                  </p>
                </div>
              </div>
              ...
              {/* Certifications Grid */}
              <div className="mb-8">
                <h4 className={`text-2xl font-bold mb-6 ${isDarkMode ? "text-cyan-300" : "text-blue-600"}`}>
                  ...
                  {[
                    {
                      ...
                      issuer: "Oracle",
                      color: isDarkMode ? "from-blue-900/30 to-blue-700/20" : "from-blue-50 to-red-100",
                      textColor: isDarkMode ? "text-blue-300" : "text-red-700",
                    },
                    {
                      title: "Oracle APEX Cloud Developer",
                      issuer: "Oracle",
                      color: isDarkMode ? "from-red-900/30 to-blue-700/20" : "from-blue-50 to-red-100",
                      textColor: isDarkMode ? "text-blue-300" : "text-red-700",
                    },
                    {
                      title: "IBM Cybersecurity Fundamentals",
                      issuer: "IBM",
                      color: isDarkMode ? "from-blue-900/30 to-blue-700/20" : "from-blue-50 to-blue-100",
                      textColor: isDarkMode ? "text-blue-300" : "text-blue-700",
                    },
                    {
                      title: "Frontend Development edunet - IBM (internship)",
                      issuer: "IBM",
                      color: isDarkMode ? "from-blue-900/30 to-green-700/20" : "from-blue-50 to-blue-100",
                      textColor: isDarkMode ? "text-blue-300" : "text-red-700",
                    },
                  ].map((cert, index) => (
                    <div
                      key={index}
                      className={`p-4 rounded-xl bg-gradient-to-br ${cert.color} border ${isDarkMode ? "border-gray-700/50" : "border-gray-200"
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`px-2 py-1 rounded text-xs ${isDarkMode ? "bg-gray-800 text-gray-300" : "bg-white text-gray-700 shadow-sm"
                          }`}>
                          ✓ Verified
                        </span>
                      </div>
                ...
                <div className={`mt-4 p-4 rounded-lg text-center ${isDarkMode ? "bg-gray-800/50" : "bg-gray-100"
                  }`}>
                  <p className={isDarkMode ? "text-gray-300" : "text-gray-700"}>
                    Backed by{" "}
              ...
              {/* Vision Statement */}
              <div className={`p-6 rounded-xl ${isDarkMode
                  ? 'bg-gradient-to-r from-cyan-900/10 to-blue-900/10 border-cyan-700/30'
                ...
                <div className="flex items-center gap-3 mt-6">
                  <div className={`w-3 h-3 rounded-full ${isDarkMode ? 'bg-cyan-400 animate-pulse' : 'bg-cyan-500'}`}></div>
        ...
        {activeTab === "portfolio" && (
          ...
          >
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative">
                  <img
                    src="/profile.jpeg"
                    alt="Profile"
                    className="w-40 h-40 rounded-full object-cover border border-cyan-400/40 shadow-lg"
                  />
                </div>
                <div className="flex-1">
                  ...
                  <div className={`p-4 rounded-lg border ${isDarkMode ? 'bg-gray-900/50 border-gray-700/50' : 'bg-white/50 border-blue-100/50'
                    }`}>
                  ...
                  <motion.a
                    ...
                    className={`inline-flex items-center mt-6 px-6 py-3 rounded-lg transition-all shadow-lg ${isDarkMode
                        ...
                        : 'bg-gradient-to-r from-blue-50 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 shadow-blue-500/20 text-white'
                      }`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {skillSystems[activeSystem].map((skill) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-xl border ${isDarkMode ? 'bg-gray-900/50 border-gray-700/50' : 'bg-white/50 border-blue-100/50'
                      }`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div key={index} className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center mt-2">
                        <span className={`px-3 py-1 rounded-full text-sm ${isDarkMode ? 'bg-blue-500/20 text-blue-300' : 'bg-blue-100 text-blue-700'
                          }`}>
                          {edu.degree}
                        </span>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {edu.courses.map((course, i) => (
                          <span key={i} className={`px-3 py-1 rounded-lg text-sm border ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
                            }`}>
                            {course}
                          </span>
                        ))}
              ...
              {/* Internship */}
              <GlassCard3D isDarkMode={isDarkMode} className="p-8" glowType="purple">
                ...
                {internships.map((internship, index) => (
                  <div key={index} className="space-y-4">
                    <div>
                      ...
                      <div className="flex items-center mt-2">
                        <span className={`px-3 py-1 rounded-full text-sm ${isDarkMode ? 'bg-purple-500/20 text-purple-300' : 'bg-purple-100 text-purple-700'
                          }`}>
                          {internship.position}
                        </span>
                        <span className={`mx-3 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>|</span>
                      ...
                      <ul className="space-y-2">
                        {internship.responsibilities.map((item, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <div className={`w-2 h-2 rounded-full mt-2 ${isDarkMode ? 'bg-cyan-400' : 'bg-blue-400'}`}></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {ongoingProjects.map((project, index) => (
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <GlassCard3D isDarkMode={isDarkMode} className="p-6 h-full">
                      ...
                      <div className="mb-6">
                        ...
                        <div className={`w-full rounded-full h-2 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-200'
                          ...
                          <div
                            className={`h-2 rounded-full bg-gradient-to-r ${isDarkMode ? 'from-cyan-5050 to-blue-500' : 'from-blue-500 to-cyan-400'
                              }`}
      ...
      {/* Style definitions for CSS 3D elements */}
      <style>{`
        .glass-card-style {
          background: linear-gradient(135deg, rgba(255, 255, 255, 0.12) 0%, rgba(4, 18, 38, 0.45) 100%);
        ...
        .glow-cyan:hover {
          box-shadow: 0 0 20px rgba(0, 229, 255, 0.15), 0 0 50px rgba(0, 229, 255, 0.08);
          border-color: rgba(0, 229, 255, 0.3) !important;
        }
        .glow-purple:hover {
          box-shadow: 0 0 20px rgba(124, 77, 255, 0.15), 0 0 50px rgba(124, 77, 255, 0.08);
        ...
        @keyframes spin-reverse {
          0% { transform: rotateX(70deg) rotateY(-15deg) rotate(360deg); }
          100% { transform: rotateX(70deg) rotateY(-15deg) rotate(0deg); }
        }
        @keyframes spin-slow {
        ...
        .cube-face {
          ...
          height: 40px;
          border-width: 1px;
          box-shadow: 0 0 8px rgba(0, 234, 255, 0.15) inset;
        }
